    ...
    <div class="container mx-auto px-4 pt-10">
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="{{ route('admin.posts.create') }}"
                class="inline-flex items-center px-6 py-3 bg-primary text-white font-semibold rounded-full hover:bg-primary-700 transition-colors duration-300">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <form action="{{ route('admin.posts.index') }}" method="GET">
                        <input type="text" name="search" placeholder="Search..."
                            class="bg-bg border border-border rounded-lg px-4 py-2 w-64">
                    </form>
                </div>
                            ...
                            <tr class="hover:bg-surface transition-colors duration-200">
                                ...
                                <td class="py-4 px-4 text-center">
                                    <a href="{{ route('admin.posts.edit', $post) }}"
                                        class="text-primary hover:text-primary-700 mr-4 font-semibold">Edit</a>
                                    <form method="POST" action="{{ route('admin.posts.destroy', $post) }}"
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                            class="text-danger hover:text-red-700 font-semibold">Delete</button>
                                    </form>
                                </td>
                            </tr>
                            @empty
