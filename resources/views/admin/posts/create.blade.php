        ...
        <div class="p-6 md:p-8">
            ...
            <form method="POST" action="{{ route('admin.posts.store') }}" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <textarea id="body" name="body" rows="10" required
                            class="w-full px-4 py-3 bg-gray-100 border-2 border-gray-200 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"></textarea>
                    </div>
                </div>
                <div>
                ...
                <div class="flex justify-end space-x-4">
                    ...
                    <button type="submit"
                        class="px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors duration-300">Publish
                        Post</button>
                </div>
            </form>
        </div>
